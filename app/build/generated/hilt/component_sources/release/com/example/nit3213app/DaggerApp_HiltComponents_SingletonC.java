...
import com.example.nit3213app.data.di.NetworkModule;
import com.example.nit3213app.data.di.NetworkModule_ProvideApiServiceFactory;
import com.example.nit3213app.data.di.NetworkModule_ProvideOkHttpClientFactory;
import com.example.nit3213app.data.di.NetworkModule_ProvideRetrofitFactory;
...
import com.example.nit3213app.ui.dashboard.DashboardViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.nit3213app.ui.details.DetailsActivity;
import com.example.nit3213app.ui.details.DetailsViewModel;
import com.example.nit3213app.ui.details.DetailsViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.nit3213app.ui.login.LoginActivity;
import com.example.nit3213app.ui.login.LoginViewModel;
import com.example.nit3213app.ui.login.LoginViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(3).add(DashboardViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(DetailsViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(LoginViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(3).put("com.example.nit3213app.ui.dashboard.DashboardViewModel", ((Provider) dashboardViewModelProvider)).put("com.example.nit3213app.ui.details.DetailsViewModel", ((Provider) detailsViewModelProvider)).put("com.example.nit3213app.ui.login.LoginViewModel", ((Provider) loginViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.nit3213app.ui.dashboard.DashboardViewModel 
          return (T) new DashboardViewModel(singletonCImpl.bindAppRepositoryProvider.get());

          case 1: // com.example.nit3213app.ui.details.DetailsViewModel 
          return (T) new DetailsViewModel();

          case 2: // com.example.nit3213app.ui.login.LoginViewModel 
          return (T) new LoginViewModel(singletonCImpl.bindAppRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.nit3213app.data.repository.AppRepositoryImpl 
          return (T) new AppRepositoryImpl(singletonCImpl.provideApiServiceProvider.get());

          case 1: // com.example.nit3213app.data.api.ApiService 
